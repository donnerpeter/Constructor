...
data Agr = Agr { gender::Maybe Gender, number::RusNumber, person::Maybe Person } deriving (Show, Eq, Ord)

agree (Agr {gender=g1, number=n1, person=p1}) (Agr {gender=g2, number=n2, person=p2}) =
