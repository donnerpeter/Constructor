...
var5 = [
  ...
  ,
  translateTest "Мы все пошли в коммерческий магазин \"Гастроном\", который на углу Театральной, Знаменской и Бассейной улиц, и спросили кассиршу о нашем недоумении"
                "We all went to a commercial grocery store, the one that's on the corner of Teatralnaya, Znamenskaya and Basseinaya streets to consult a cashier on our predicament"
  ,
  -- 5_Shorter
...
var12 = [
  ...
  translateTest "По мнению кассирши и по мнению других, семь идет раньше восьми"
                "In the opinion of the cashier and in the opinion of others, a seven comes before an eight"
  ,
  -- 12_InOpinionCoordinationNumbers
  translateTest "По мнению кассирши и по мнению других, 7 идет раньше 8"
                "In the opinion of the cashier and in the opinion of others, a 7 comes before an 8"
  ,
  ...
  translateTest "По словам кассирши и по мнению других, 7 идет раньше 8"
                "According to the cashier and in the opinion of others, a 7 comes before an 8"
  ,
...
varUnsorted = [
  ...
  ,
  translateTest "Я забыл, по словам кого семь идет после восьми."
                "I forgot according to whom a seven comes after an eight."
  ,
  ...
  ,
  translateTest "Кассирша идет с улицы Бассейной в магазин"
                "The cashier goes from the street Basseinaya to the store"
  ,
  translateTest "Кассирша идет в магазин, а кассир - в сад"
  ...
  ,
  translateTest "Глупый кассир идет в магазин, а умные - в сад"
                "The stupid cashier goes to the store, but the smart ones - to the garden"
  ,
  translateTest "Кассирша идет на работу"
                "The cashier goes to the work"
  ,
